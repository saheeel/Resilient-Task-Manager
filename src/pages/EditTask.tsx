  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 md:p-8 border border-slate-200 rounded-xl shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900 mb-8 tracking-tight">Edit Task</h1>
            ...
            <div className="space-y-5">
              ...
              <div>
                  ...
                  {attachment && (
                    <div className="flex items-center gap-2 text-sm text-slate-600 bg-slate-100 px-3 py-1.5 rounded-lg max-w-[200px]">
                      ...
                      <button 
                        ...
                        className="text-slate-400 hover:text-red-500 cursor-pointer animate-fade-in"
                      >
                        <X size={14} />
                      </button>
                    </div>
                ...
                {existingAttachments.length > 0 && (
                  <div className="mt-3">
                    <span className="block text-xs text-slate-500 mb-1.5 font-medium">Existing Files:</span>
