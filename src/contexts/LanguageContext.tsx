...
const translations: Record<Language, TranslationTree> = {
  en: {
    ...
    calendar: {
      title: 'Calendar',
      subtitle: 'See upcoming work in a daily, weekly, or monthly scheduling view.',
      weeklyOverview: 'Weekly Overview',
      weeklyOverviewSubtitle: 'A faster way to scan your schedule, spot overlaps, and open tasks directly.',
      ...
      agendaView: 'Agenda',
      allTypes: 'All Types',
      quickPreview: 'Task Preview',
      viewDetails: 'View Full Details',
      quickComplete: 'Mark as Completed',
      filterCadence: 'Cadence Filter',
      noTasksScheduled: 'No tasks scheduled for this period.',
    },
    horizon: {
      all: 'All Work',
      today: 'Today (Daily)',
  ...
  de: {
    ...
    calendar: {
      title: 'Kalender',
      subtitle: 'Sieh anstehende Aufgaben in einer Tages-, Wochen- oder Monatsansicht.',
      weeklyOverview: 'Wochenübersicht',
      weeklyOverviewSubtitle: 'Ein schneller Überblick über deine Termine, Überschneidungen und Aufgaben.',
      ...
      agendaView: 'Agenda',
      allTypes: 'Alle Typen',
      quickPreview: 'Aufgaben-Vorschau',
      viewDetails: 'Vollständige Details',
      quickComplete: 'Als erledigt markieren',
      filterCadence: 'Intervall-Filter',
      noTasksScheduled: 'Keine Aufgaben für diesen Zeitraum geplant.',
    },
    horizon: {
      all: 'Alle Aufgaben',
      today: 'Heute (Täglich)',
    ...
    sort: {
      default: 'Empfohlen',
      dueDateAsc: 'Fälligkeitsdatum: Früheste zuerst',
      dueDateDesc: 'Fälligkeitsdatum: Späteste zuerst',
      priority: 'Priorität (Hoch → Niedrig)',
      frequency: 'Intervall (Täglich → Wöchentlich → Monatlich)',
    },
    notifications: {
