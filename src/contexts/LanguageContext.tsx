...
const translations: Record<Language, TranslationTree> = {
  en: {
    ...
    common: {
      ...
      recurringRoutines: 'Recurring Routines',
    ...
    employeeDashboard: {
      ...
      recurringTab: 'Recurring Routines',
      oneTimeTab: 'One-Time Tasks',
      quickComplete: 'Quick Check-off (Done)',
  ...
  de: {
    ...
    common: {
      ...
      recurringRoutines: 'Wiederkehrende Routinen',
      oneTimeTasks: 'Einmalige Aufgaben',
    },
    nav: {
    ...
    employeeDashboard: {
      ...
      frequency: 'Häufigkeit (Täglich → Wöchentlich → Monatlich)',
      byEmployee: 'Nach Mitarbeiter gruppieren',
      allTasksTab: 'Alle Aufgaben',
      recurringTab: 'Wiederkehrende Routinen',
      oneTimeTab: 'Einmalige Aufgaben',
      quickComplete: 'Schnell abhaken (Erledigt)',
      allCaughtUp: 'Alles erledigt!',
